...
using Project_63135188.Models;

namespace Project_63135188.Controllers
{
  public class QuanLies63135188Controller : Controller
  {
    // Database
    private Project_63135188Entities db = new Project_63135188Entities();
    ...
    {
      if (Session["_taiKhoan"] == null) return RedirectToAction("DangNhap", "HeThong63135188");
    ...
    public ActionResult ThemSinhVien(string maSV, string hoSV, string tenSV, bool gioiTinh, DateTime ngaySinh, string lop, bool dongPhi, string anhSV, string queQuan, string sdtSV, string matKhau, string email, string maPhong)
    {
      ...
      string ngay_sinh = DateTime.ParseExact(ngaySinh.ToShortDateString(), "dd/MM/yyyy", null).ToString("yyyy-MM-dd");
      ...
      var js = "<script>window.location.href='/QuanLies63135188/TimKiemSinhVien'; localStorage.clear()</script>";
    ...
    public ActionResult ThongKe(string phongTim = "")
    {
      ...
      var a = db.Database.SqlQuery<TraCuuPhongThieuNguoi63135188>(cmd).ToList();
